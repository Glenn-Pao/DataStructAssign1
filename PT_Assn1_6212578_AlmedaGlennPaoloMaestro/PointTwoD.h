...
///summary
///
/// The main class referenced by MissionPlan class to perform it's tasks
/// It holds the coordinates, composition, distance and civilization index of the star system in question
///
///end summary
